...
<html lang="pt-br">
                ...
                <article class="conteudo_adm_conf2 radius">
                    <div class="informacao_adm_conf2">
                     <?php   include_once "conexao.php";
                        echo "<h2>São Sebastião"."</h2><br>";


  $rs = $conexao->query("select count(cidade_fotografo) as 'Sao_sebastiao' from cidade_fotografo
    where cidade_fotografo = 'Sao sebastiao'");

  while($row = $rs->fetch(PDO::FETCH_OBJ))
      {

        echo "<div class='pergunta'> Contem ".$row->Sao_sebastiao." Fotógrafos nessa Cidade.</div><br>";
  ...
  $rs = $conexao->query("select nome_fotografo from cadastro_fotografo, endereco_fotografo, bairro_fotografo, cidade_fotografo
    where endereco_fotografo.idcadastro_fotografo = cadastro_fotografo.idcadastro_fotografo
      ...
      and cidade_fotografo = 'Sao sebastiao'");
