                ...
                <article class="conteudo_adm_conf2 radius">
                    <div class="informacao_adm_conf2">
                     <?php   include_once "conexao.php";
                       echo "<h2>Santos"."</h2><br>";


  $rs = $conexao->query("select count(cidade_fotografo) as 'Santos' from cidade_fotografo
    where cidade_fotografo = 'Santos'");

  while($row = $rs->fetch(PDO::FETCH_OBJ))
      {

       echo "<div class='pergunta'> Contem ".$row->Santos." Fotógrafos nessa Cidade.</div><br>";
