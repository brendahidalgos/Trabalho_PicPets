...
//--------------------------------------------------------------------------------
			echo "<h2> Endereço </h2>";
  $rs = $conexao->query("select endereco_fotografo, cep_fotografo, complemento_fotografo
  from cadastro_fotografo, endereco_fotografo
  where cadastro_fotografo.idcadastro_fotografo = endereco_fotografo.idcadastro_fotografo");

        while($row = $rs->fetch(PDO::FETCH_OBJ))
      
      {
        echo "<div class='pergunta'>Edereço: </div><div class='resposta'>".$row->endereco_fotografo."</div><br>";
        echo "<div class='pergunta'>CEP: </div><div class='resposta'>".$row->cep_fotografo."</div><br>";
        echo "<div class='pergunta'>Complemento: </div><div class='resposta'>".$row->complemento_fotografo."</div><br>";
        echo "<br><br><br>";
