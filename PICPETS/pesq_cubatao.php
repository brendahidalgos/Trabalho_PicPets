                ...
                <article class="conteudo_adm_conf2 radius">
                    <div class="informacao_adm_conf2">
                       ...
                       <?php   include_once "conexao.php";
                        echo "<h2>Cubatão"."</h2><br>";


  $rs = $conexao->query("select count(cidade_fotografo) as 'Cubatão' from cidade_fotografo
    where cidade_fotografo = 'Cubatão'");

  while($row = $rs->fetch(PDO::FETCH_OBJ))
      {

         echo "<div class='pergunta'> Contem ".$row->Cubatão." Fotógrafos nessa Cidade.</div><br>";
