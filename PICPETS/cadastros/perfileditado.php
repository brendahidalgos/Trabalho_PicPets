        ...
        <div class="banner container">
          <div class="title_geral">
            <main class="conteudos container">
          	<article class="conteudo_pro_login_cli bg-white radius">
...
//Se esse valores, diferentes do cpf e da senha dadas pelo usuario anteriormente ele direciona para o login 
...
//seleciona(pega) os valores que estao na tabela cadastro_cliente
...
//Seleção de tudo da tabela cadastro onde o cpf_fotografo é igual a variavel $cpf_fotografo
			...
			while($row = $rs->fetch(PDO::FETCH_OBJ))
			{
				?>
						...
						<img class="img_perfil_cli_l_1" src="<?php echo $row->foto_perfil_fotografo;?>"></div><br><br><br><br><br><br><br><br><br><br>
						<?php
						echo "<br><p class='texto_pro_login_cli'>Nome: "."<div class='input_pro_login'><h5>".$row->nome_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>Data de nascimento:"."<div
							class='input_pro_login'><h5>".$row->data_nascimento_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>Senha: "."<div
							class='input_pro_login'><h5>".$row->senha_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>CPF: "."<div
							class='input_pro_login'><h5>".$row->cpf_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>DDD: "."<div
							class='input_pro_login'><h5>".$row->ddd_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>Email: "."<div
							class='input_pro_login'><h5>".$row->email_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>Celular: "."<div
							class='input_pro_login'><h5>".$row->celular_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>Telefone: "."<div
							class='input_pro_login'><h5>".$row->telefone_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>Endereço: "."<div
							class='input_pro_login'><h5>".$row->endereco_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>CEP: "."<div
							class='input_pro_login'><h5>".$row->cep_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>Complemento: "."</h5><div
							class='input_pro_login'><h5>".$row->complemento_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>Bairro: "."<div
							class='input_pro_login'><h5>".$row->bairro_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>Cidade: "."<div
							class='input_pro_login'><h5>".$row->cidade_fotografo."</h5></h5></div>";

						echo "<br><p class='texto_pro_login'>UF: "."<div
							class='input_pro_login'><h5>".$row->uf_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>País: "."<div
							class='input_pro_login'><h5>".$row->pais_fotografo."</h5></div>";

						echo "<br><p class='texto_pro_login'>Formação: "."<div
							class='input_pro_login'><h5>".$row->formacao."</h5></div>";

						echo "<br><p class='texto_pro_login'>Nível de ensino: "."<div
							class='input_pro_login'><h5>".$row->nivel_ensino."</h5></div>";?>

						<p>Diploma: <div class='input_pro_login_cli'></p>
						<div class="botoes">
							<button class=" radius ver5" type="submit" value="Cadastre-se"><a href="<?php echo $row->diploma_certificado;?>" target="_blank">Ver certificado/diploma</a></button>
							</div>
				...
				<p>Descrição:</p><h5><textarea class="input_pro_login_descricao" cols="" rows=""><?php echo $row->descricao_fotografo;}}}?></textarea></h5><br><br>	
<!-- Botão sair da secão que é direcionado a pagina sair.php onde é fechada a seção e direciona o usuario para a pagina de login--><br><br>
<div class="botoes">
...
</div></form></div></article></main></div></div>
	<!-- RODAPÉ -->
