...
<html lang="pt-br">
    ...
    echo "<h2> Todos os Contatos </h2>";
                         $rs = $conexao->query("select email_fotografo, celular_fotografo, telefone_fotografo from contato_fotografo");

  while($row = $rs->fetch(PDO::FETCH_OBJ))
      {
        echo "<div class='pergunta'>Email: </div><div class='resposta'>".$row->email_fotografo."</div><br>";
        echo "<div class='pergunta'>Celular: </div><div class='resposta'>".$row->celular_fotografo."</div><br>";
        echo "<div class='pergunta'>Telefone: </div><div class='resposta'>".$row->telefone_fotografo."</div><br>";?>
        <?php
        echo "<br><br><br>";
      }
                    ?>
