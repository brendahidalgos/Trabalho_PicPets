...
<h2>Alterar minha senha</h2><br>
    <div class="pergunta">Nova senha: <input class="input" type="text" name="novo"></div><br>
    <div class="pergunta">Confirme a senha: <input class="input" type="text" name="confirmacao"></div>
    <div class="botoes">
    <button class="botoes_conf botoes_login radius" type="submit" name="alterar" value="senha"><a>Enviar</a></button></div><br>
