              ...
              <article class="conteudo_adm_conf3 radius">
                ...
                <article class="conteudo_adm_conf2 radius">
                    ...
                    <?php   include_once "conexao.php";
                        echo "<h2>Mongagua"."</h2><br>";


  $rs = $conexao->query("select count(cidade_fotografo) as 'Mongagua' from cidade_fotografo
    where cidade_fotografo = 'Mongagua'");

  while($row = $rs->fetch(PDO::FETCH_OBJ))
      {
        echo "<div class='pergunta'> Contem ".$row->Mongagua." Fotógrafos nessa Cidade.</div><br>";
