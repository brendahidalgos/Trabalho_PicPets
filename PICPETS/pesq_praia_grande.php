...
<html lang="pt-br">
  ...
  echo "<h2>Praia Grande"."</h2><br>";

  $rs = $conexao->query("select count(cidade_fotografo) as 'Praia_Grande' from cidade_fotografo
    where cidade_fotografo = 'Praia Grande'");

  while($row = $rs->fetch(PDO::FETCH_OBJ))
      {

        echo "<div class='pergunta'> Contem ".$row->Praia_Grande." Fotógrafos nessa Cidade.</div><br>";
  ...
  $rs = $conexao->query("select nome_fotografo from cadastro_fotografo, endereco_fotografo, bairro_fotografo, cidade_fotografo
    where endereco_fotografo.idcadastro_fotografo = cadastro_fotografo.idcadastro_fotografo
      ...
      and cidade_fotografo = 'Praia Grande'");
