...
<html lang="pt-br">
 ...
 <article class="conteudo_adm_conf3 radius">
                      <div class="informacao_adm_conf3">
                        ...
                        <div class="botoes">
                        <button class="botoes_conf botoes_conf_adm2 radius" type="submit"><a href="pesq_excluir_usuario.php">Excluir Usuário</a></button>
                         </div>

                         <div class="botoes">
                        <button class="botoes_conf botoes_conf_adm2 radius" type="submit"><a href="pesq_editar_usuario.php">Editar Usuário</a></button>
                         </div>

                         <div class="botoes">
                        <button class="botoes_conf botoes_conf_adm2 radius" type="submit"><a href="pesq_alterar_minha_senha.php">Alterar minha senha</a></button>
                         </div>
...
//--------------------------------------------------------------------------------
//Senha atual
  $senha_atual = $_SESSION['criptografia'];
//Nova senha
  $senha = $_POST['novo'];
  $confirmacao = $_POST['confirmacao'];

  //Se a a senha nova for a mesma de confirmacao
  if($senha == $confirmacao)
  {
    //criptografa a senha digitada
    $criptografar = md5($senha);
    //Altera os dados no banco
    $stmt1 = $conexao->prepare("UPDATE admin set senha_admin = '$criptografar' where senha_admin = '$senha_atual'"); 
    //Executa
    $stmt1->execute();
    ...
    echo "<h2>As senha não batem tente novamente</h2>";
  }
