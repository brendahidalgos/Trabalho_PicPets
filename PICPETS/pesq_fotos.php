...
//--------------------------------------------------------------------------------
                 ...
                 $rs = $conexao->query("select nome_fotografo from cadastro_fotografo where cadastro_fotografo.idcadastro_fotografo = nome_fotografo.idcadastro_fotografo");
                 $rs = $conexao->query("select imagem1, imagem2, imagem3, imagem4, imagem5, imagem6, imagem7, imagem8, imagem9, imagem10 from cadastro_fotografo, imagens
where cadastro_fotografo.idcadastro_fotografo = imagens.idcadastro_fotografo");

                      while($row = $rs->fetch(PDO::FETCH_OBJ))
                    {
                      echo "<div class='pergunta'> Nome:</div><div class='resposta'>".$row->nome_fotografo;
                 ?></div><br>
	<div class="container_img">
        <img class="img_port_perfil2" src="cadastros/<?php echo $row->imagem1;?>">
        <img class="img_port_perfil2" src="cadastros/<?php echo $row->imagem2;?>">
        <img class="img_port_perfil2" src="cadastros/<?php echo $row->imagem3;?>">
        <img class="img_port_perfil2" src="cadastros/<?php echo $row->imagem4;?>">
        <img class="img_port_perfil2" src="cadastros/<?php echo $row->imagem5;?>">
        <img class="img_port_perfil2" src="cadastros/<?php echo $row->imagem6;?>">
        <img class="img_port_perfil2" src="cadastros/<?php echo $row->imagem7;?>">
        <img class="img_port_perfil2" src="cadastros/<?php echo $row->imagem8;?>">
        <img class="img_port_perfil2" src="cadastros/<?php echo $row->imagem9;?>"></div>
        <img class="img_port_perfil3" src="cadastros/<?php echo $row->imagem10;?>">
