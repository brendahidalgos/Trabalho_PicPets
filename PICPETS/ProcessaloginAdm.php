...
//Selecio informações do banco
$rs = $conexao->query("select email_admin, senha_admin from admin where email_admin = '$email' and senha_admin = '$criptografia'");
...
//Cria as variaveis de sessao
  ...
  $_SESSION['criptografia'] = $criptografia;}
    ?>
        <!-- CABEÇALHO --> 
            ...
            <main class="conteudos container">
                ...
                <article class="conteudo_adm_conf2 radius">
                    <div class="informacao_adm_conf2">
                        <h2> Pic Pets <br> Aqui você encontra o melhor fotográfo para seu Pet.<br></h2>
                    </div></article></div>
