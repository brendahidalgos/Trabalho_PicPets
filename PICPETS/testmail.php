...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="banner container">
          ...
          <article class="conteudo_email radius">
            ...
            <br>
              <?php
                ...
                $From ="$email";
                $To = "grupopicpets@gmail.com";
                $Subject = "$assunto";
                $Message = "$mensagem";
                $Headers = "DE: ".$conf_email;
                Mail ($To, $Subject, $Message, $Headers);
                Echo "<h2>A mensagem de e-mail foi enviada.</h2><br><br>";
             ?>
                
 </form></div></article></main></div></div>
          <!-- RODAPÉ -->
