                ...
                <article class="conteudo_adm_conf2 radius">
                    <div class="informacao_adm_conf2">
                     <?php   include_once "conexao.php";
                        ...
                        echo "<h2>Guarujá"."</h2><br>";


  $rs = $conexao->query("select count(cidade_fotografo) as 'Guarujá' from cidade_fotografo
    where cidade_fotografo = 'Guarujá'");

  while($row = $rs->fetch(PDO::FETCH_OBJ))
      {

               echo "<div class='pergunta'> Contem ".$row->Guarujá." Fotógrafos nessa Cidade.</div><br>";
